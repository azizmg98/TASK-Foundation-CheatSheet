...
<!-- var is used to declare a variable globally while let is local. ie. var inside func can be used out of func : https://www.tutorialspoint.com/difference-between-var-and-let-in-javascript-->
variables -> `let`
`let`: for variables
`const`: for constants
...
let a = 1234567890;
// String:
let b = "qwertyuiop[]asdfghjkl;'zxcvbnm,./1234567890-=``''"; 
// backslash escapes the string
...
const x = 5;
const y = 10;
console.log(x,y); // 5 Hello World 10
...
// or assignments assign a value to variable if empty ||=
```
...
```js
array.push(newElement); // adds a new element
