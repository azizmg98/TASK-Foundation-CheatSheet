...
/* you can also use hex, rgb, and hsl value */
```
...
/* borders have many styles (solid, ridge, etc...) */
/* width can be set with thin medium thick in place of 4px */
```
...
/*To hide an element  */
display: none;
/* we can also use visibility: hidden; */
```
